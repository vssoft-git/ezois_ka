...
Функция ШаблоныНазначенийДокументаОперации(
	...
	Запрос.УстановитьПараметр("СценарийСБП", СистемаБыстрыхПлатежейСлужебный.ИдентификаторВариантаНастройки(ВариантНастройки));
...
Процедура ОбновитьШаблоныНазначений(
	...
	Попытка
		...
		Для Каждого ДанныеШаблона Из ШаблоныНазначений Цикл
			...
			НовыйШаблон.СценарийСБП = СистемаБыстрыхПлатежейСлужебный.ИдентификаторВариантаНастройки(ВариантНастройки);
