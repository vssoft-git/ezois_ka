...
#Область ТекстЗапроса
	ТекстЗапроса =
		...
		|				ИЛИ ВТПродукция.Организация.ГоловнаяОрганизация = Затраты.Организация
		|				ИЛИ ВТПродукция.Организация.ГоловнаяОрганизация = Затраты.Организация.ГоловнаяОрганизация
		|				ИЛИ ВТПродукция.Организация = Затраты.Организация.ГоловнаяОрганизация)
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
		...
		// Добавляем филиалы головной организации, филиалы с одной и той же головной организацией, и головную организацию филиала.
		|				ИЛИ Затраты.Организация.ГоловнаяОрганизация = КоличествоВыпуска.Организация
		|				ИЛИ Затраты.Организация.ГоловнаяОрганизация = КоличествоВыпуска.Организация.ГоловнаяОрганизация
		|				ИЛИ Затраты.Организация = КоличествоВыпуска.Организация.ГоловнаяОрганизация)
		|ГДЕ
