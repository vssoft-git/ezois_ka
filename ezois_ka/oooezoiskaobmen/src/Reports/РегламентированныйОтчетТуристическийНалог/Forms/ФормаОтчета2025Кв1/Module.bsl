...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если Год(СтруктураРеквизитовФормы.мСохраненныйДок.ДатаОкончания) >= 2026
		...
		СообщитьВТС("С 24.04.2026 представление первичной декларации по туристическому налогу, начиная с отчета за период "
			+ "1 квартал 2026 года, доступно только по форме в редакции приказа ФНС России от 19.12.2025 № ЕД-7-3/1228@",
