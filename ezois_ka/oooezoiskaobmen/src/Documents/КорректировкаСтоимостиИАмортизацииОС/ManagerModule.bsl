...
Процедура ЗаполнитьНаОснованииДокумента(Объект, ДанныеЗаполнения) Экспорт
	...
	ИначеЕсли ТипДанныхЗаполнения = Тип("ДокументСсылка.ИзменениеПараметровОС2_4") Тогда
		...
		ЗаполнитьДокументНаОснованииИзменениеПараметровОС(Объект, ДанныеЗаполнения);
...
Процедура ЗаполнитьДокументНаОснованииИзменениеПараметровОС(Объект, Основание)

	ПродолжитьЗаполнение = КорректировкаСтоимостиИАмортизацииОСЛокализация.ЗаполнитьДокументНаОснованииИзменениеПараметровОС(Объект, Основание);
