...
Процедура СуммаНДССМежценовойРазницы(МенеджерВременныхТаблиц, ПараметрыОсновногоЗапроса) Экспорт
	...
	|			ТОГДА СчетФактураВыданныйТовары.СуммаНДС
	|	КОНЕЦ КАК СуммаНДСМежценоваяРазницаУСНОсновнаяРасчетнаяСтавка,
	|	ВЫБОР
	|		КОГДА СчетФактураВыданныйТовары.СтавкаНДС = &СтавкаНДС5_105
	|			ТОГДА СчетФактураВыданныйТовары.СуммаНДС
	|	КОНЕЦ КАК СуммаНДСМежценоваяРазницаУСНПониженнаяРасчетнаяСтавка
	...
	|	СУММА(НДССМежценовойРазницыПредварительная.СуммаНДСМежценоваяРазницаУСНОсновнаяРасчетнаяСтавка) КАК СуммаНДСМежценоваяРазницаУСНОсновнаяРасчетнаяСтавка,
	|	СУММА(НДССМежценовойРазницыПредварительная.СуммаНДСМежценоваяРазницаУСНПониженнаяРасчетнаяСтавка) КАК СуммаНДСМежценоваяРазницаУСНПониженнаяРасчетнаяСтавка
