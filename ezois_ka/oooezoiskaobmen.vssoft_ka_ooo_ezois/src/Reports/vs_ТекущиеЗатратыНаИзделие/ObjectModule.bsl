...
//#КонецВставки
	...
	СтруктураСерииДерево = СтруктураСерииНоменклатуры(ПараметрыОтчета, ПревышенЛимитСтрок, ИсключеннаяНоменклатура);
...
//	ЗаполнитьСтрокиРекурсивно(СтруктураСерииДерево, ОбластьСтрока, 0, ДокументРезультат); 
	...
	СтруктураСерии = ЗаполнитьСтрокиРекурсивно(СтруктураСерииДерево, ТЗ); 
	ТЗ = Неопределено;
...
//	КонецЕсли;
////#КонецВставки
    СформироватьТабличныйДокументНаСервере(СтруктураСерии,ДокументРезультат,ДанныеРасшифровки);
КонецПроцедуры

Процедура СформироватьТабличныйДокументНаСервере(СтруктураСерии,ТабДокумент,ДанныеРасшифровки)
    
    //ТабДокумент = Новый ТабличныйДокумент;
    
    
    ИсточникиДанных = Новый Структура("СтруктураСерии", СтруктураСерии);
...
Функция СтруктураСерииНоменклатуры(Параметры, ПревышенЛимитСтрок, ИсключеннаяНоменклатура)
...
Функция ЗаполнитьСтрокиРекурсивно(СтруктураСерииДерево, ТЗ)
	...
	Для каждого СтрокаДерева Из СтруктураСерииДерево.Строки Цикл
		Если Не ЗначениеЗаполнено(СтрокаДерева.НоменклатураУзел) Тогда
			ЗаполнитьЗначенияСвойств(ТЗ.Добавить(), СтрокаДерева);
		КонецЕсли;
