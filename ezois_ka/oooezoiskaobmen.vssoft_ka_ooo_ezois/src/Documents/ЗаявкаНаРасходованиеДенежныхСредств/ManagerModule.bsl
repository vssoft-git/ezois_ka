...
//Функция vs_НастройкиПолейФормы()
//	
...
//#Вставка
//	//Элемент.Поля.Добавить("РасшифровкаПлатежаvs_ЗаполнитьСчетНаОплату");
//	//Элемент.Поля.Добавить("РасшифровкаПлатежаvs_ЗаполнитьСчетНаОплату1");
//#КонецВставки
